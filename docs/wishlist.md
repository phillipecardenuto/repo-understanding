...
| [#22](https://github.com/phillipecardenuto/repo-understanding/issues/22) | System view from docker-compose: services linked to code, dev/prod merged, infrastructure separated | P1 | L |
...
| # | Item | Priority | Size |
|---|---|---|---|
| [#34](https://github.com/phillipecardenuto/repo-understanding/issues/34) | Persistent on-disk parse cache (SQLite, JSON payloads) | P2 | M |
